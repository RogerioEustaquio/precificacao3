Ext.define('App.view.rpe.NodeWindowCexplore', {
    extend: 'Ext.window.Window',
    xtype: 'nodewindowcexplore',
    itemId: 'nodewindowcexplore',
    height: 300,
    width: 800,
    ...
    constructor: function() {
        ...
        var elementbx = Ext.create('Ext.form.field.Tag',{
            ...
            store: Ext.data.Store({
                ...
                proxy: {
                    type: 'ajax',
                    url: BASEURL + '/api/cexplore/listarElementos',
                    timeout: 120000,
                    reader: {
                        type: 'json',
                        root: 'data'
        ...
        var myStore = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                method:'POST',
                url : BASEURL + '/api/cexplore/listarordemagrupamento',
                timeout: 240000,
                reader: {
                    type: 'json',
                    root: 'data'
