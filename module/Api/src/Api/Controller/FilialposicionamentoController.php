...
class FilialposicionamentoController extends AbstractRestfulController
{
    ...
    public function filialposicionamentoAction()
    {
        $data = array();
        ...
        try {
            ...
            from (select emp,
                    ...
                    from (select rede, id_empresa, emp,
                                    rol,
                                    lb,
                                    mb,
                                    qtde,
